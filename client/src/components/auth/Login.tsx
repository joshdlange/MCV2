...
import { signInWithAppleUnified } from "../../auth/appleSignIn";
              ...
              <Card className="bg-gray-900/80 border-gray-800 shadow-2xl backdrop-blur">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {/* Apple Sign In - shown first per Apple guidelines */}
                    <Button 
                      onClick={handleAppleSignIn}
                      disabled={isLoading}
                      variant="outline"
                      className="w-full bg-white hover:bg-gray-100 text-black border-gray-300 py-3 font-semibold h-12"
                    ...
                    <Button 
                      ...
                      disabled={isLoading}
                      variant="outline"
                      className="w-full bg-white hover:bg-gray-100 text-gray-900 border-gray-300 py-3 font-semibold h-12"
