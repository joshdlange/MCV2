    ...
    const friendships = await db
      .select({
        ...
        requester: {
          ...
          collectorAvatarKey: requesterAlias.collectorAvatarKey,
        ...
        recipient: {
          ...
          collectorAvatarKey: recipientAlias.collectorAvatarKey,
    ...
    const requests = await db
      .select({
        ...
        requester: {
          ...
          collectorAvatarKey: requesterTable.collectorAvatarKey,
        ...
        recipient: {
          ...
          collectorAvatarKey: recipientTable.collectorAvatarKey,
