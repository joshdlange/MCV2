...
Fast no-op probes must enforce every identity and terminal-shape invariant that the locked repair enforces. For small target sets, prefer always running the advisory-locked terminal validator instead of maintaining a second, weaker probe.
