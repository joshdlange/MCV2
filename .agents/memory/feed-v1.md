...
- Card events must persist their exact related card ID. Legacy first-card fallback is only for relation-less rows; a stored ID always wins. Card IDs and images must also be removed at read time when another collector has hidden their collection.
